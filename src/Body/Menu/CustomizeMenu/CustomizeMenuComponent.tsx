...
export const CustomizeMenuNoRedux = (props: IProps) => {
    ...
    return( 
        <Modal show={props.isOpen} size='lg' onHide={() => {handleHide()}} >
            <Modal.Header>
                <h2>
                    Customize
                </h2>
            ...
            <Modal.Body>
                ...
                <Col>
                    ...
                    <Row>
                        <ChoiceComponent isRadio={props.baseData.size[0].isRadio} data={props.baseData.size[0].items} onSelection={(x: string | string[]) => setSize(x)}/>
                    </Row>
                    <Row>
                        {
                            hasError ? 
                    ...
                    <Row>
                        <ChoiceComponent isRadio={props.baseData.toppings[0].isRadio} data={props.baseData.toppings[0].items} onSelection={(x: string | string[]) => setToppings(x)}/>
...
export const CustomizeMenu = connect(mapStateToProps, mapDispatchToProps)(CustomizeMenuNoRedux);